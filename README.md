...
**Примечание:** Переменная `ADMIN_PASSWORD` больше не используется. Вместо этого при первом открытии сайта вы пройдете регистрацию с email и паролем.
...
**Важно:** Сохраните ваш email и пароль - они понадобятся для входа в систему.
